...
def Directory():
    ...
    # dir = '../../test_images/k-fold/Amazonia_Legal/'
    # dir_Images_past = dir + '2/pix2pix_bs1_wise_frame_mean_ps128_op70_ep50_fold_' + str(kk) + '_2018_07.npz'
    # dir_Image_present = dir + '2/pix2pix_bs1_wise_frame_mean_ps128_op70_ep50_fold_' + str(kk) + '_2019_07.npz'
    
    dir = '../../../datasets/Amazonia_Legal/Landsat_8/Images/'
    dir_Images_past = dir + '24_07_2018_image.npy'
    dir_Image_present = dir + '27_07_2019_image.npy'

    dir = '../../../datasets/Amazonia_Legal/Landsat_8/Reference/'
    dir_reference = dir + "REFERENCE_2019_EPSG32620.npy"
    dir_past_reference = dir + 'PAST_REFERENCE_FOR_2019_EPSG32620.npy'
