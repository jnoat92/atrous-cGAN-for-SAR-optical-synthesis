...
#            atrous_rates = (12, 24, 36)
        ...
        x, skip1 = _xception_block(x, [256, 256, 256], 'entry_flow_block2',
                                   skip_connection_type='conv', stride=2,
                                   depth_activation=True, return_skip=True)
...
# backbones: xception and mobilenetv2
if __name__ == "__main__":
    Deeplabv3p = Deeplabv3p(weights=None, input_tensor=None, infer = False,
              input_shape=(128, 128, 16), classes=3, backbone='xception',
              OS=8, alpha=1.)
    Deeplabv3p.summary()
