...
#parser.add_argument("--gpu_id", type=int, default=0, help="Id of the GPU to be used")
#parser.add_argument("--crop_size", type=int, default=513, help="Image Cropsize.")
#parser.add_argument('--starting_learning_rate', type=float, default=0.00001, help="initial learning rate.")
#parser.add_argument("--multi_grid", type=list, default=[1,2,4], help="Spatial Pyramid Pooling rates")
#parser.add_argument("--current_best_val_loss", type=int, default=99999, help="Best validation loss value.")
#parser.add_argument("--accumulated_validation_miou", type=int, default=0, help="Accumulated validation intersection over union.")
...
parser.add_argument("--output_stride", type=int, default=8, help="Spatial Pyramid Pooling rates")
...
parser.add_argument("--sampling_type", default="dropout", choices=["uniform", "normal", "dropout", 'none'], help="Noise used in the GAN")
...
parser.add_argument("--norm_type", default="wise_frame_mean", choices=["min_max", "std", "wise_frame_mean"], help="Type of normalization ")
...
# parser.add_argument('--dataset_name', dest='dataset_name', default='Cerrado_biome', choices=["Amazonia_Legal", "Cerrado_biome"], help='name of the dataset')
# parser.add_argument("--patch_overlap", type=float, default=0.83, help="Overlap percentage between patches")

parser.add_argument('--dataset_name', dest='dataset_name', default='Amazonia_Legal', choices=["Amazonia_Legal", "Cerrado_biome"], help='name of the dataset')
parser.add_argument("--patch_overlap", type=float, default=0.70, help="Overlap percentage between patches")
