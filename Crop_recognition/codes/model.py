...
class pix2pix(object):
    def __init__(self, sess, args, image_size=256, load_size=286,
        ...
        if args.dataset_name == 'LEM':

            self.sar_name = '01_20170612_S1A_10m'
            self.opt_name = '02_20170615_L08_30m'
            self.lbl_name = '03_Jun2017_10m'

        elif args.dataset_name == 'Campo_Verde':

            self.sar_name = '08May_2016'
            self.opt_name = '20160505'
            self.lbl_name = '10_May_2016'
    ...
    def build_model(self):
        ...
        self.d_optim = tf.train.AdamOptimizer(self.Lr/10, beta1=self.args.beta1) \
