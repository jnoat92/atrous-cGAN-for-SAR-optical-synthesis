...
# -*- coding: utf-8 -*-
"""
Created on Tue Nov 19 15:57:23 2019
...
import numpy as np
import sys
from Arquitecturas.layers_fusion import TransitionDown, TransitionUp, SoftmaxLayer,SepConv_BN
...
#####################     
    ...
    for i in range(n_pool):
        for j in range(n_layers_per_block[i]):
            l = SepConv_BN(stack, dropout_p, filters = growth_rate, prefix = 'layers_separable_conv{}'.format(idb),
        ...
        stack = TransitionDown(stack, n_filters, dropout_p, idb)
...
if __name__ == "__main__":
    model = Tiramisu(input_shape=(512,512,3), n_classes = 2, n_filters_first_conv = 48, n_pool = 5, growth_rate = 16 , n_layers_per_block = [4,5,7,10,12,15,12,10,7,5,4], dropout_p = 0.2)
