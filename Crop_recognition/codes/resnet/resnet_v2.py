    ...
    with tf.variable_scope(scope, 'resnet_v2', [inputs], reuse=reuse) as sc:
        ...
        with slim.arg_scope([slim.conv2d, bottleneck,
            ...
            if include_root_block:
                ...
                #__________________No@_____________________#####
                # We comment this pooling layer to obtain a tensor
                # shape of (none, 32, 32, 7) at block 4, otherwise
                # it will be (none, 16, 16, 7)
